...
const faqItems: FaqItem[] = [
  {
    ...
    a: "В большинстве случаев один день. Сложные многоуровневые конструкции — до двух дней. Точные сроки скажем после осмотра."
  },
  {
  ...
  },
  {
    ...
    a: "Цена зависит от площади, типа материала и сложности конструкции. Точную стоимость фиксируем после осмотра объекта — она не меняется."
  },
  {
  ...
  {
    q: "Даёте ли гарантию?",
    a: "Да, мы предоставляем официальную гарантию 10 лет на все виды работ и материалы."
  }
];
